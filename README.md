...
```json
// https://slavikklimov1988.github.io/goit-js-hw-09/
"homepage": "https://slavikklimov1988.github.io/goit-js-hw-09",
"scripts": {
  "build": "parcel build src/*.html --public-url /goit-js-hw-09/"
},
```
